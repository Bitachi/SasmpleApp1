...
if __name__ == '__main__':
    ...
    if args != None:
        ...
        print("command line arguments not setted")
        my_token = 'MsKONPkSOov7Y9p2pxt8IOPlWHCsBJ2RXxRFSrUmWg9'
        month = '2'
        day = '14'
        hour = '22'
        minute = '00'
    ...
    while h == 1:
        ...
        # Chromeを起動
        driver = webdriver.Chrome(executable_path="/Users/takamigo/simple_web_crawlers/chromedriver", options=options)
